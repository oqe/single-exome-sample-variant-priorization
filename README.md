...
**genopheno_analysis.nf** maybe used for pre-existing sample vcfs that maybe from earlier cohort vcf extraction workflow run or for example generated by commercial sequencing service (as per patient).
